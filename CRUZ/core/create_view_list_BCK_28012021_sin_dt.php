...
$string .= '                                <input type="text" class="form-control single-daterange" placeholder="<?php echo $total_rows ?> Resultados" name="q" value="<?= $q ?>">'."\n";
...
if($posicion_botones=='derecha'){
    $string .= '                        <th class="text-center"><span class="d-none d-sm-table-cell">Acciones</span></th>'."\n";
}
