    ...
    <?php $datacfg->template = isset($datacfg->template)?$datacfg->template : ''; ?>
        <div class="form-group">
            ...
            <select name="template" id="template" class="form-control">
                <option value="" <?=isset($datacfg->template) && $datacfg->template==''?'selected="selected"':''?>>Sin template (por defecto)</option>
    ...
    <div class="col-md-2">
        <div class="form-group">
            ...
            <select name="estilo" id="estilo" class="form-control">
                <option value="" <?=isset($datacfg->estilo) && $datacfg->estilo==''?'selected="selected"':''?>>Sin estilo (por defecto)</option>
...
<table class="table table-striped">
    ...
    <tr>
        ...
        <td>
            ...
            <div class="divinputrutafichero" style="<?=empty($datacfg->tipo_campo_file_ruta->$c['column_name'])?'display:none;':''?>">
                    <div class="form-group">
                        <div class="col-md-2">
                            <label class="labelrelacion">Directorio: </label>
                        </div>
                        <div class="col-md-10">
                            <input type="text" class="form-control inputrutafichero" name="tipo_campo_file_ruta[<?=$c['column_name']?>]" value="<?=!empty($datacfg->tipo_campo_file_ruta->$c['column_name'])?$datacfg->tipo_campo_file_ruta->$c['column_name']:''?>" placeholder="Ruta fichero"/>
                        </div>
                    </div>
            </div>
        ...
        <input type="checkbox" name="tipo_campo[<?=$c['column_name']?>]" class="selectcheckbox_campofile" value="file" <?=isset($datacfg->tipo_campo->$c['column_name'])?'checked':''?> />
        <input type="radio" name="tipo_campo_file[<?=$c['column_name']?>]" value="archivo" <?=isset($datacfg->tipo_campo_file->$c['column_name'])?'checked':''?>>Archivo
        <input type="radio" name="tipo_campo_file[<?=$c['column_name']?>]" value="imagen" <?=isset($datacfg->tipo_campo_file->$c['column_name'])?'checked':''?>>Imagen
        <input class="form-control labelcampos" type="text" name="tipo_campo_file_ruta[<?=$c['column_name']?>]" value="<?=isset($datacfg->tipo_campo_file_ruta->$c['column_name'])?$datacfg->tipo_campo_file_ruta->$c['column_name']:''?>" placeholder="Ruta fichero"/>
