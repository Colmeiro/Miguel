...
$config['forced_cors_headers'] = [
  ...
  'Access-Control-Allow-Headers' => 'Content-Type, Content-Length, Accept-Encoding,cache-control, X-API-KEY',
  'Access-Control-Allow-Credentials' => 'true',
 ...
 * PROPIO.
 * 
 * Determinamos si la key es aleatoria (como sería originalmente), o bien utilizamos métodos crypt propios para encriptar información útil para identificar un usuario concreto.
 */
$config['is_key_by_crypt'] = TRUE;

$config['user_id_field'] = 'usuario_id';
 ...
 */
$config['key_nokey_both_allowed'] = TRUE;