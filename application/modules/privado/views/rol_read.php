                                ...
                                <div class="card-body pr-0 pl-0">
									...
									<div class="row">
                                        <div class="col-6 d-flex justify-content-start">
                                            <a href="<?php echo site_url('privado/rol') ?>" class="btn btn-light-secondary ml-1 ml-sm-2 mb-1"><i class="bx bx-chevrons-left"></i>Volver</a> 
                                        </div>
                                        <div class="col-6 d-flex justify-content-end">
                                            <a href="<?= site_url('privado/rol/update/' . $data_fields['rol_id']) ?>" class="btn btn-success mr-1 mb-1"><i class="bx bx-edit"></i><span class="d-none d-sm-inline-block">Editar</span></a>

                                            <a href="<?= site_url('privado/rol/delete/' . $data_fields['rol_id']) ?>" onclick="javascript: return confirm('Seguro que deseas eliminar este usuario?')" class="btn btn-danger mr-1 mr-sm-2 mb-1"><i class="bx bx-trash"></i></a>
										</div>
                                    </div>
								</div>
                            </div>
