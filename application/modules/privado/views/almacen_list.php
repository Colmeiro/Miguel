                ...
                <div class="card">
                    ...
                    <div class="table-responsive">
                        <table id="table-extended-dt" class="dt-almacen table mb-0">
                            <thead class="bg-pep">
                                <tr>
                                    <th class="sorting text-left"><a>Situación</a></th>
                                ...
                                <tr>
                                    <th class="text-left"><a>Situación</a></th>
                            ...
                            <!-- <tfoot>
                                <tr class="dt-footer active">
                                    <th class="text-left"><input type="text" class="text_filter text-left form-control" placeholder="Buscar Situación"></th>
