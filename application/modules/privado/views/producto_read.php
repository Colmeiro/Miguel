                    ...
                    <div class="col-md-6 col-12">
                        <div class="card">
                            <div class="card-header bg-light-blue">
                                <h4 class="card-title"><?= isset($subtitulo) ? $subtitulo : '' ?>: <?php echo daFormato($data_fields['producto_nombre'], 'varchar', '0-#475F7B', '') ?> </h4>
                            </div>
                                ...
                                <div class="card-body pr-0 pl-0">
                                    ...
                                    <div class="table-responsive">
                                        <table id="table-extended-transactions" class="table mb-2">
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo daFormato($data_fields['producto_nombre'], 'varchar', '0-#333333', '') ?></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <!-- <?php echo daFormato($data_fields['producto_activo'], 'checkbox', '0-#333333', '') ?> -->
                                                    <?php if ($data_fields['producto_activo']==1) { ?>
                                    ...
                                    <div class="row">
                                        <div class="col-6 d-flex justify-content-start">
                                            <a href="<?php echo site_url('privado/producto') ?>" class="btn btn-light-secondary ml-1 ml-sm-2 mb-1"><i class="bx bx-chevrons-left"></i>Volver</a> 
                                        </div>
                                        <div class="col-6 d-flex justify-content-end">
                                            <a href="<?= site_url('privado/producto/update/' . $data_fields['producto_id']) ?>" class="btn btn-success mr-1 mb-1"><i class="bx bx-edit"></i><span class="d-none d-sm-inline-block">Editar</span></a>

                                            <a href="<?= site_url('privado/producto/delete/' . $data_fields['producto_id']) ?>" onclick="javascript: return confirm('Seguro que deseas eliminar este producto?')" class="btn btn-danger mr-1 mr-sm-2 mb-1"><i class="bx bx-trash"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
